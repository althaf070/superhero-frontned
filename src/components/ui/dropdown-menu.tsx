...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "yflex ycursor-default ygap-2 yselect-none yitems-center yrounded-sm ypx-2 ypy-1.5 ytext-sm youtline-none focus:ybg-accent data-[state=open]:ybg-accent [&_svg]:ypointer-events-none [&_svg]:ysize-4 [&_svg]:yshrink-0",
      inset && "ypl-8",
      className
    )}
    {...props}
  >
    {children}
    <ChevronRight className="yml-auto" />
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "yrelative yflex ycursor-default yselect-none yitems-center ygap-2 yrounded-sm ypx-2 ypy-1.5 ytext-sm youtline-none ytransition-colors focus:ybg-accent focus:ytext-accent-foreground data-[disabled]:ypointer-events-none data-[disabled]:yopacity-50 [&_svg]:ypointer-events-none [&_svg]:ysize-4 [&_svg]:yshrink-0",
      inset && "ypl-8",
      className
    )}
    {...props}
